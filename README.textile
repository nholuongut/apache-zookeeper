...
"This project":http://github.com/nholuongut/apache-zookeeper provides a unix "top" like utility for ZooKeeper. It is compatible with Python2.6, Python2.7 and Python3.
